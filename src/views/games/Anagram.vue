                    ...
                    <v-row>
                        ...
                        <v-col class="py-0" cols="12" sm="6" md="3">
                            <v-text-field
                                    ...
                                    placeholder="Исходное слово из которого будут составляться слова"
                                    outlined
                                    v-model="settings.start_word"
                                    :rules="rules_start_word"
                                    validate-on-blur
                            ><template v-slot:prepend-inner >
                                <v-tooltip bottom color="rgba(48, 44, 44, 0.99)" max-width="280">
                                    <template v-slot:activator="{ on }">
                                    ...
                                    <span>Введите слово, из которого другие участники будут составлять слова. Например,
                                        из слова "Подарок" можно составить слова "дар" и "кора". Не забудьте указать исходное слово в посте.</span>
                                </v-tooltip>
    ...
    export default {
        ...
        data: () => ({
            settings: {
                ...
                word_count_strategy: '',
                game_duration: '',
                post_text: 'У нас игра: анаграммы 😍\n' +
                    '\n' +
                    'Ваша задача — собрать как можно больше слов из слова ___.\n' +
                    'Победители (кто соберёт больше всех слов) - получат подарки 🎁\n' +
                    '\n' +
                    'В комментариях под этим постом пишите слова, которые смогли собрать. Один комментарий - одно слово.' +
            ...
            mechanics_textarea_block: [
                {
                    id: 'message_valid',
                    value: '',
                    label: 'Игрок ввёл верное слово (угадал)',
                ...
                // },
                {
                    id: 'message_not_original',
                    value: '',
                    label: 'Слово должно отличаться от оригинального слова',
                    list_of_variables_for_rules: []
                },
                {
                    id: 'message_char_not_found',
                    value: '',
                    label: 'Одна из букв не найдена в исходном слове',
                    list_of_variables_for_rules: []
                },
                {
                    id: 'message_char_limit',
                    value: '',
                    label: 'Одна из букв в исходном слове встречается меньше раз',
                    list_of_variables_for_rules: []
                },
                {
        ...
        computed: {
            ...
            rules_start_word () {
                return [
                    ...
                    v => /^(\D){1,30}$/g.test(v) || 'Не более 30 символов'
                ]
            },
            rules_game_duration () {
                return [
