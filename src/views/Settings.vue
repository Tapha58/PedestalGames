...
<script>
    ...
    export default {
        ...
        props: ['license_expiration_at', 'settings', 'auth_data_url', 'data_bus', 'online'],
        data: () => ({
            loader: 'loading',
            loading: false,
        ...
        computed: {
            ...
            integration_btn_name: function () {
                if (this.data_bus.pedestal_integration_enabled === true) {
                    return 'Деактивировать'
                } else if (this.data_bus.pedestal_integration_enabled === false) {
                    return 'Активировать'
                } else {
                    return ''
                }
        ...
        methods: {
            ...
            put_data_group: async function () {
                ...
                obj.pedestal_integration_enabled = !this.data_bus.pedestal_integration_enabled
