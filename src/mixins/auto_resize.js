        ...
        auto_resize: function () {
            if (bridge.supports("VKWebAppResizeWindow")) {
                bridge.send("VKWebAppResizeWindow", {
                    "width": 795,
                    "height": +Math.max(document.body.offsetHeight, 150) + 10
                });
            }
        },
...
//             },
        getAllUrlParams: async function () {
            ...
            //     // console.log('2 - ' + sessionStorage.getItem('auth_data_url'))
            //     url = sessionStorage.getItem('auth_data_url')
            //
            // }
            this.auth_data_url = url
            // console.log(url)
...
// The substituted value will be contained in the result variable
        ...
        getAllUrlParamsAndRecordInSessionStorage: async function () {
